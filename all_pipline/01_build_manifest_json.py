...
if __name__ == "__main__":
    ...
    parser.add_argument("--labels_txt", type=str,
                        default="E:\\桌面\XJUNLP\\Construction Dataset\\ImageNet50K\\imagenet_2012_validation_synset_labels.txt",
                        help="Path to the txt file containing ordered WNIDs")

    parser.add_argument("--class_index", type=str,
                        default="E:\\桌面\XJUNLP\\Construction Dataset\\ImageNet50K\\imagenet_class_index.json",
                        help="Path to the class index json file")

    # 图片目录配置
    parser.add_argument("--dataset_root", type=str,
                        default="E:\\桌面\XJUNLP\\Construction Dataset\\ImageNet50K\\ILSVRC2012_img_val",
