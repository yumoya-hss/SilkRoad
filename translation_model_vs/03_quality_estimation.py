...
DEFAULT_COMET_PATH = "/mnt/raid/hss/model/wmt22-cometkiwi-da" 

# 🔥 [新增] COMET 底座模型路径 (必须手动下载 infoxlm-large) 🔥
# 用于防止 COMET 尝试联网下载 microsoft/infoxlm-large
DEFAULT_COMET_ENCODER_PATH = "/mnt/raid/hss/model/infoxlm-large"

# CLIP 模型 (用于视觉一致性)
DEFAULT_CLIP_PATH = "/mnt/raid/hss/model/clip-vit-large-patch14"

# 🔥 [新增] BERTScore 模型 (本地路径) 🔥
# 您下载的是 xlm-roberta-large，这是一个强大的多语言模型
DEFAULT_BERT_PATH = "/mnt/raid/hss/model/xlm-roberta-large"

# 图片根目录 (路径回退用)
DEFAULT_IMAGE_ROOT = "/mnt/raid/hss/dataset/Image50K"
