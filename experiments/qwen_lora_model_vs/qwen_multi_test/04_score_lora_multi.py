...
# ================= 🔴 2. 路径配置 🔴 =================
BASELINE_FILE = "pred_100_baseline_multi.json"
FINETUNED_FILE = "pred_100_finetuned_multi.json"
OUTPUT_CSV = "final_experiment_results_full.csv"

# 1. CometKiwi
KIWI_ROOT = "models/wmt22-cometkiwi-da"
INFOXLM_PATH = "models/infoxlm-large"

# 2. BERTScore (XLM-R)
XLMR_PATH = "models/xlm-roberta-large"

# 3. ✅ PPL (改为 Multilingual BERT)
# 假设您的 mBERT 路径如下，如果没有，可改为 XLMR_PATH (XLM-R 也是 BERT 架构)
PPL_MODEL_PATH = "models/xlm-roberta-large"

# 4. Visual Models
SIGLIP_PATH = "models/siglip-so400m-patch14-384"
CLIP_BASE_PATH = "models/clip-vit-base-patch32"
CLIP_LARGE_PATH = "models/clip-vit-large-patch14"
# =========================================================
