...
def main():
    ...
    parser.add_argument("--image_root", type=str, default="/mnt/raid/hss/dataset/Image50K")
    parser.add_argument("--save_path", type=str, default="./siglip_features.pt")
    parser.add_argument("--siglip_path", type=str, default="/mnt/raid/hss/model/siglip-so400m-patch14-384")
